...
export const collections = [
  { id: 1, name: "🧒 Kids Tiffin", count: 12, color: "bg-secondary" },
  { id: 2, name: "💪 Gym Diet", count: 8, color: "bg-success-light" },
  { id: 3, name: "🏠 Family Meals", count: 24, color: "bg-primary-light" },
  { id: 4, name: "🎉 Party Specials", count: 6, color: "bg-warning-light" },
];
